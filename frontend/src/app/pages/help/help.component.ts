  ...
  template: `
    <div class="help-container">
      ...
      <div class="help-content">
        ...
        <!-- GitHub Repository -->
        <section class="help-section github-section">
          <h2>📦 {{ t('help.github.title') }}</h2>
          <div class="github-card">
            <p>{{ t('help.github.description') }}</p>
            <a href="https://github.com/CyrilBaillet/aws-cost-auditor" target="_blank" rel="noopener noreferrer" class="github-link">
              ...
              <span>github.com/CyrilBaillet/aws-cost-auditor</span>
            </a>
          </div>
        </section>
